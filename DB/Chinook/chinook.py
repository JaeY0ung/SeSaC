...
def mission_1():
    cursor.execute('SELECT FirstName||" "||LastName as FullNames, customerid, country  FROM Customers;')
...
# SELECT c.FirstName||" "||c.LastName as "Customer's Full Name", i.invoiceid, i.invoicedate, i.Billingcity 
# FROM customers c
